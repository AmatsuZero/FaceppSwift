...
final class FppAFaceAlbumCreateCommand: FaceCLIBaseCommand {
    ...
    func run() throws {
        ...
        try setup()
        semaRun { sema in
            FaceAlbum.create(option: option) { error, resp in
...
final class FppFaceAlbumDeleteCommand: FaceCLIBaseCommand {
    ...
    func run() throws {
        ...
        try setup()
        semaRun { sema in
            FaceAlbum.delete(option: option) { err, resp in
...
final class FppFaceAlbumFindCommand: FaceCLIBaseCommand {
    ...
    func run() throws {
        ...
        try setup()
        semaRun { sema in
            FaceAlbum.findCandidate(option: option) { err, resp in
                commonResponseHandler(sema, error: err, resp: resp)
            }
        }
    }
...
""")
    ...
    func run() throws {
        ...
        semaRun { sema in
            FaceAlbum.searchImage(option: option) { err, resp in
                commonResponseHandler(sema, error: err, resp: resp)
            }
        }
    }
...
final class FppFaceAlbumUpdateCommand: FaceCLIBaseCommand {
    ...
    func run() throws {
        ...
        try setup()
        semaRun { sema in
            FaceAlbum.updateFace(option: option) { err, resp in
                commonResponseHandler(sema, error: err, resp: resp)
            }
        }
    }
...
final class FppFaceAlbumAddFaceCommand: FaceCLIBasicCommand {
    ...
    func runSync() throws {
        ...
        option.imageBase64 = imageBase64
        semaRun { sema in
            FaceAlbum.addImage(option: option) { err, resp in
                commonResponseHandler(sema, error: err, resp: resp)
            }
        }
    }
    ...
    func runAsync() throws {
        ...
        semaRun { sema in
            FaceAlbum.addImageAsync(option: option) { err, resp in
                commonResponseHandler(sema, error: err, resp: resp)
            }
        }
    }
...
final class FppFaceAlbumGetDetailCommand: FaceCLIBaseCommand {
    ...
    func run() throws {
        ...
        try setup()
        semaRun { sema in
            FaceAlbum.getFaceDetail(option: option) { err, resp in
                commonResponseHandler(sema, error: err, resp: resp)
            }
        }
    }
...
final class FppGetImageDetailCommand: FaceCLIBaseCommand {
    ...
    func run() throws {
        ...
        try setup()
        semaRun { sema in
            FaceAlbum.getImageDetail(option: option) { err, resp in
                commonResponseHandler(sema, error: err, resp: resp)
            }
        }
    }
...
final class FppGetAllFaceAlbumFCommand: FaceCLIBaseCommand {
    ...
    func run() throws {
        ...
        try setup()
        semaRun { sema in
            FaceAlbum.getAll(option: option) { err, resp in
                commonResponseHandler(sema, error: err, resp: resp)
            }
        }
    }
...
final class FppFaceAlbumGetdetailCommand: FaceCLIBaseCommand {
    ...
    func run() throws {
        ...
        try setup()
        semaRun { sema in
            FaceAlbum.getAlbumDetail(option: option) { err, resp in
                commonResponseHandler(sema, error: err, resp: resp)
            }
        }
    }
...
final class FppFaceAlbumRemoveFaceCommand: FaceCLIBaseCommand {
    ...
    func run() throws {
        ...
        try setup()
        semaRun { sema in
            FaceAlbum.deleteFace(option: option) { err, resp in
                commonResponseHandler(sema, error: err, resp: resp)
            }
        }
    }
...
final class FppFaceAlbumGroupFaceCommand: FaceCLIBaseCommand {
    ...
    func run() throws {
        ...
        try setup()
        semaRun { sema in
            FaceAlbum.groupFace(option: option) { err, resp in
                commonResponseHandler(sema, error: err, resp: resp)
            }
        }
    }
