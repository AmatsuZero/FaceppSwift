...
public extension UIImage {
    @discardableResult
    func licensePlate(completionHandler: ((Error?, ImageppLicensePlateResponse?) -> Void)? = nil) -> URLSessionTask? {
    ...
    @discardableResult
    func recognizeText(completionHandler: ((Error?, ImagepprecognizeTextResponse?) -> Void)? = nil) -> URLSessionTask? {
    ...
    @discardableResult
    func detectSceneandObject(completionHandler: ((Error?, ImageppDetectScenceAndObjectResponse?) -> Void)? = nil) -> URLSessionTask? {
